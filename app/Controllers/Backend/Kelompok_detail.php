...
use App\Models\Backend\KelompokDetailModel;
use App\Libraries\Date\DateFunction;

class Kelompok_detail extends BaseController
{
    protected $m_kelompok_detail;
    protected $session;
    public function __construct()
    {
        $this->m_kelompok_detail = new KelompokDetailModel();
    ...
    public function index()
    {
        ...
        $data = [
            'title'  => 'Kelompok Detail',
            'active' => 'kelompok_detail',
        ];
        return view('admin/kelompok_detail/index', $data);
    }
    public function getData()
    {
        $res = $this->m_kelompok_detail->getAturkelompok();
        $nomor = 1;
        if (count($res) > 0) {
            foreach ($res as $data) {
    ...
    public function form_insert()
    {
        ...
        $result1['data1'] = $this->m_kelompok_detail->getIdPeriode();
            $msg = [
                'data' => view('admin/kelompok_detail/form_update', $result1),
            ];
