...
class HarianModel extends Model
{
    ...
    public function getHarian($user_id)
    {
        $query = $this->db->table('laporan_harian a');
        $query->select('a.id,a.judul,a.dokumen,a.nilai,a.created_at,b.name,c.nama,d.periode_nm,d.semester_cd,d.tanggal_buka,d.tanggal_tutup');
