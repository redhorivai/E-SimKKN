...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="<?= base_url('panel/imut'); ?>">Konten</a>
          <a class="breadcrumb-item" href="<?= base_url('panel/imut'); ?>">Profil</a>
          <span class="breadcrumb-item active"><?= $title; ?></span>
        </nav>
    </div>
    <!-- END BREADCRUMB -->
    <!-- SECTION TABLE -->
    <div id="viewData" class="br-pagebody viewdata">
        <div class="br-section-wrapper">
            <div class="table-wrapper">
                ...
                <div class="dataTables_length pd-b-5">
                  <button type="button" onclick="_btnAdd()" class="btn btn-info btn-with-icon mg-b-10" style="box-shadow: 0 2px 5px 0 rgba(0, 0, 0, .16), 0 2px 10px 0 rgba(0, 0, 0, .12) !important;">
                    <div class="ht-40">
                ...
                <!-- END BUTTON ADD -->
                <!-- TABLE -->
                <?= form_open('Backend/Aturkelompok/multi_del', ['class' => 'formMultiDelete']) ?>
                <table id="viewTable" class="table display responsive w-100">
                  <thead>
                    <tr>
                      ...
                      <th class="tx-center">Data Detail Kelompok</th>
