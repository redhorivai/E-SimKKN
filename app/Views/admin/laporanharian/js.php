...
<script type="text/javascript">
  ...
  function _getLaporanharian() {
    $('#viewTable').DataTable({
      ...
      "ajax": "<?= site_url('Backend/Laporanharian/getData') ?>",
    });
  }
  ...
  function _btnReport() {
    ...
    if (tglAwal && tglAkhir) {
      $.ajax({
        url: "<?= site_url('Backend/Laporanharian/view_report') ?>",
        type: "POST",
        data: {
          tglAwal: tglAwal,
          tglAkhir: tglAkhir,
  ...
  function _detail(id) {
    $.ajax({
      url: "<?= site_url('Backend/Laporanharian/detail') ?>",
      type: "POST",
      data: {
        id: id
      },
  ...
  function _btnCek(id) {
    $.ajax({
      url: "<?= site_url('Backend/Laporanharian/ceknilai') ?>",
      type: "POST",
      data: {
        id: id
      },
  ...
  function _simpan(id) {
    ...
    if (nilai) {
      $.ajax({
        url: "<?= site_url('Backend/Laporanharian/insert_data') ?>",
        type: "POST",
        data: {
          nilai: nilai,
          id: id,
  ...
  function _rekapnilai(kelompok_id) {
    $.ajax({
      url: "<?= site_url('Backend/Laporanharian/rekap_nilai_mahasiswa') ?>",
      type: "POST",
      data: {
