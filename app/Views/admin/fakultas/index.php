...
<div class="br-mainpanel">
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <a class="breadcrumb-item" href="javascript:void(0)">Data Master</a>
    ...
    <div id="viewData" class="br-pagebody">
        <div class="br-section-wrapper">
            <div class="table-wrapper">
                ...
                <!-- END BUTTON ADD -->
                <!-- TABLE -->
                <?= form_open('Backend/HakKewajiban/multi_del', ['class' => 'formMultiDelete']) ?>
                <table id="viewTable" class="table display responsive w-100">
                  <thead>
                    <tr>
                      ...
                      <th class="tx-center">Fakultas</th>
